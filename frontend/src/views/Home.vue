<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">OMNIAGENT SWARM</div>
      <div class="nav-links">
        <LanguageSwitcher />
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="nexus-tag">{{ $t('home.tagline') }}</span>
          ...
          <div class="hero-desc">
            <p>
              <i18n-t keypath="home.heroDesc" tag="span">
                ...
                <template #agentScale><span class="highlight-primary">{{ $t('home.heroDescAgentScale') }}</span></template>
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <div class="hero-logo-placeholder" style="font-size: 3rem; font-weight: bold; background: linear-gradient(135deg, #6366f1, #a855f7); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Nexus</div>
          </div>
...
.gradient-text {
  background: linear-gradient(90deg, var(--nexus-primary) 0%, var(--nexus-secondary) 100%);
