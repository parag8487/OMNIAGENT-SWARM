<template>
  <div class="process-page">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">OMNIAGENT SWARM</div>
...
.loading-ring:nth-child(1) {
  width: 80px;
  height: 80px;
  border-top-color: var(--nexus-text);
}
...
.loading-ring:nth-child(2) {
  ...
  top: 10px;
  left: 10px;
  border-right-color: var(--nexus-primary);
...
.loading-ring:nth-child(3) {
  ...
  top: 20px;
  left: 20px;
  border-bottom-color: var(--nexus-subtext);
