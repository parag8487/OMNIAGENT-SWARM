...
.actions-tooltip::before {
  ...
  border-bottom: 6px solid var(--nexus-text);
}
...
.platform-status.twitter .platform-icon { color: var(--nexus-text); }
.platform-status.reddit .platform-icon { color: var(--nexus-text); }
...
.breakdown-item.twitter { color: var(--nexus-text); }
.breakdown-item.reddit { color: var(--nexus-text); }
...
.timeline-item.twitter .marker-dot { background: var(--nexus-text); }
.timeline-item.reddit .marker-dot { background: var(--nexus-text); }
.timeline-item.twitter .timeline-marker { border-color: var(--nexus-text); }
.timeline-item.reddit .timeline-marker { border-color: var(--nexus-text); }
...
.badge-post { background: var(--nexus-glass); color: var(--nexus-text); border-color: var(--nexus-border); }
.badge-comment { background: var(--nexus-glass); color: var(--nexus-subtext); border-color: var(--nexus-border); }
.badge-action { background: #FFF; color: var(--nexus-subtext); border: 1px solid var(--nexus-border); }
...
.log-header {
  display: flex;
  justify-content: space-between;
  border-bottom: 1px solid var(--nexus-text);
  padding-bottom: 8px;
  margin-bottom: 8px;
  font-size: 10px;
  color: var(--nexus-subtext);
...
.log-content::-webkit-scrollbar-thumb { background: var(--nexus-text); border-radius: 2px; }
