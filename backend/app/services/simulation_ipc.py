...
logger = get_logger('swarm.simulation_ipc')
...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - "reddit": Reddit only
                - None: Dual platform or single platform as configured
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            interviews: Interview list, each item has {"agent_id": int, "prompt": str, "platform": str(optional)}
            platform: Default platform (optional, can be overridden)
                - "twitter": Twitter only
                - "reddit": Reddit only
                - None: Dual platform for each Agent
            timeout: Timeout
            
        Returns:
            IPCResponse, result field contains all results
        """
    ...
    def check_env_alive(self) -> bool:
        ...
        Determined by checking env_status.json
        """
