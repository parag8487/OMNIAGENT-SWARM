...
2. Plan outline structure first, then generate segment by segment.
3. Each segment uses ReACT multi-round thinking and reflection mode.
4. Support dialogue with the user, autonomously calling retrieval tools during conversation.
"""
...
logger = get_logger('swarm.report_agent')
...
class ReportLogger:
    ...
    Generates agent_log.jsonl in the report folder, recording every detailed action.
