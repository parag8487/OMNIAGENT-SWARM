...
Runs simulations in background and records Agent actions, supporting real-time monitoring.
"""
...
logger = get_logger('swarm.simulation_runner')
...
class SimulationRunState:
    ...
    # Independent rounds and simulation time for each platform
...
class SimulationRunner:
    ...
    3. Providing real-time state query API
