...
logger = get_logger('omniagent.api.simulation')


# Interview prompt 优化前缀
# 添加此前缀可以避免Agent调用工具，直接用文本回复
INTERVIEW_PROMPT_PREFIX = "Combining your persona and all past memories/actions, reply directly in text without calling any tools: "
    ...
    请求（JSON）：
        {
            ...
            "graph_id": "omniagent_xxxx",    // 可选，如不提供则从project获取
